...
O Capítulo~\ref{cap:fundamentacao} reúne a fundamentação teórica necessária à
...
O Capítulo~\ref{cap:comp4} descreve a interface de linha de comando
...
O Capítulo~\ref{cap:conclusao} integra as contribuições dos quatro componentes
